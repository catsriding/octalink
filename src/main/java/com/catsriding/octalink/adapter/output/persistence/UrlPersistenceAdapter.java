package com.catsriding.octalink.adapter.output.persistence;

import com.catsriding.octalink.adapter.output.persistence.entity.UrlEntity;
import com.catsriding.octalink.adapter.output.persistence.exception.UrlEntityNotFoundException;
import com.catsriding.octalink.adapter.output.persistence.repository.UrlRepository;
